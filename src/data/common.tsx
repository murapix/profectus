    ...
    const resetButton = createClickable(() => {
        ...
        return {
            ...
            display:
                ...
                ((): JSX.Element => (
                    <span>
                        ...
                        <NamedResource
                            resource={conversion.gainResource}
                            override={Decimal.max(unref(conversion.actualGain), unref(resetButton.minimumGain))}
                            amountTag="b"
                        />{" "}
                        ...
                        {unref(resetButton.showNextAt) != null ? (
                            <div>
                                ...
                                <NamedResource
                                    resource={conversion.baseResource}
                                    override={!unref(conversion.buyMax) &&
            ...
            onClick: function (e?: MouseEvent | TouchEvent) {
                ...
                conversion.convert();
                if (tree != undefined && treeNode != undefined)
                    tree.reset(treeNode);
                if (resetTime) {
 ...
 * @param color The color to change the content to look like. Defaults to the current layer's feature background variable.
 */
export function colorText(textToColor: string, color = "var(--feature-background)"): JSX.Element {
